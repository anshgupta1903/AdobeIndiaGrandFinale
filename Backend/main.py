...
# # Mount the session files directory to be served statically
# app.mount("/session_files", StaticFiles(directory=SESSION_FILES_DIR), name="session_files")

# # --- Add CORS Middleware ---
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=["http://localhost:3080", "http://localhost:8080"], # Add both ports
...
# # ==============================================================================
# # Authentication Dependency & API Routes
# # ==============================================================================

# async def get_current_user(authorization: str = Header(None)): # Make optional for now
...
# # ... (all your other API routes like /register, /login, /analyze, etc. go here) ...
# @app.post("/register")
...
#     """
#     Catch-all route:
#     - If the requested file exists inside frontend/build, serve it
